...
func get():
	...
	var text = ["The Piercing Arrow hits the {first target} along any hexagonal line for {3} damage."]
	...
	fa_text1 = "The Archer can also shoot along \"hex diagonal\" lines to hit tricky shots."
