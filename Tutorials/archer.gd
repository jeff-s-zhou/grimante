...
func get():
	...
	var text = ["The Archer is your 3rd Hero."]
	
	add_player_start_rule(tutorial, 1, text)
	
	text = ["The Archer's Direct Attack: Piercing Arrow hits the closest target in any hexagonal direction for {3} damage."]
	...
	"The arrow deals {1 less damage to each successive enemy} until it fails to kill."]
	...
	add_forced_action(tutorial, 3, Vector2(3, 7), Vector2(2, 5), text)
