...
func get():
	...
	add_forced_action(tutorial, 1, Vector2(3, 7), Vector2(3, 6), text)
	...
	add_forced_action(tutorial, 1, Vector2(2, 6), Vector2(3, 5), text)
	
	add_forced_action(tutorial, 2, Vector2(2, 6), Vector2(2, 5))
	
	var fa_text1 = "The Frost Knight can only move in the 6 hexagonal directions, even when Inspired."
	add_forced_action(tutorial, 2, Vector2(3, 6), Vector2(5, 6))
