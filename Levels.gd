...
var sandbox_allies = {4: Berserker, 5: Cavalier, 3:Assassin}

var sandbox_enemies = [
{Vector2(1, 2):make(Fortifier, 3), Vector2(2, 3): make(Grunt, 5), Vector2(3, 4):make(Fortifier, 3), Vector2(4, 5): make(Grunt, 5), Vector2(5, 6):make(Fortifier, 3)}
]
