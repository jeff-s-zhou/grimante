...
func sandbox_allies():
	return {3: Archer, 4: Assassin, 5: Cavalier, 6: FrostKnight}
	
func sandbox_enemies():
	var enemies = {0:{Vector2(3, 5): make(Grunt, 3), Vector2(3, 3): make(Grunt, 3), Vector2(1, 3): make(Grunt, 3)},
...
func rising_tides():
	...
	var enemies = EnemyWrappers.FiniteCuratedWrapper.new(raw_enemies)
	var tutorial = load("res://Tutorials/rising_tides.gd").new()
	var tutorial_func = funcref(tutorial, "get")
	var flags = ["no_stars", "no_inspire"]
